...
<?php
    ...
    $query = mysqli_query($con,"SELECT codCliente, nome FROM cliente;");
?>
...
<table  style="width: 260px; height: 100px">
    ...
    <?php while($prod = mysqli_fetch_array($query)) { ?>
        ...
        <tr>
            <td>
                <label><?php echo $prod['codCliente'] ?></label>
            </td>
            <td>
                <label><?php echo $prod['nome'] ?></label>
            </td>
            <td>
                <a href="Cliente_deletar.php?id=<?php echo $prod['codCliente']?>">
                    <img src="_img/excluir.jpg" height="20" width="20" /></a>
            </td>
            <td>
                <a href="Cliente_alterar.php?id=<?php echo $prod['codCliente']?>">
    ...
    <li class="active">
        <div id="div_conteudo">
            ...
            <form action="Cliente_cadProc.php" method="get">
                <table >
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tabelaCadastro"><input type="text" name="nome" required="true"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tabelaCadastro"><select name="tipo">
                                <option value="ps">Pessoa Fisica</option>
