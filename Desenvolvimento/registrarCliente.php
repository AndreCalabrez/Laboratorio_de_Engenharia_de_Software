...
$tipo = $_GET['tipo'];
$cpf = $_GET['cpf'];
$inscricao_estadual = $_GET['inscricao_estadual'];
$bairro = $_GET['bairro'];

$sql= "INSERT INTO cliente (nome, rua,numero, telefone, tipo, cpf_cnpj, inscricao_estadual, cod_bairro) 
         VALUES ('$nome','$rua','$numero','$telefone', '$tipo', '$cpf','$inscricao_estadual', $bairro)";
